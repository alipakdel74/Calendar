...
object FallbackIslamicConverter {
    ...
    private fun tmoonphase(n: Long, nph: Int): Double {
        ...
        val t2 = T * T
        val t3 = t2 * T
        val jd = 2415020.75933 + 29.53058868 * k - 0.0001178 * t2 - 0.000000155 * t3 + 0.00033 * Math.sin(RPD * (166.56 + 132.87 * T - 0.009173 * t2))
        ...
        when (nph) {
            ...
            1, 3 -> {
                ...
                xtra =
                    if (nph == 1) xtra + 0.0028 - 0.0004 * cos(sa) + 0.0003 * cos(ma) else xtra-0.0028+0.0004 * cos(sa) -0.0003 * cos(ma)
            }
            else -> return 0.0
        }
